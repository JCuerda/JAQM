                            ...
                            <td class="text-center">
                                ...
                                <div class="btn-group">
                                    ...
                                    <!-- <ul class="dropdown-menu"> -->
                                        ...
                                        <!-- <li> -->
                                        <button id="shortlist-applicant" class="btn-info btn-xs waves-effect" data-applicant-id="<?php echo $a->applicant_id;?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Mark Applicant as Shortlisted"><i class="fa fa-list-alt"></i></button>
                                        <!-- </li> -->
                                        <!-- <li> -->
                                        <button id="interview-applicant" class="btn-success btn-xs waves-effect" data-applicant-id="<?php echo $a->applicant_id;?>" data-toggle="tooltip" data-placement="top" title="" data-original-title="Mark as Interview"><i class="fa fa-phone-square"></i></button>
                                        <!-- </li> -->
                                    <!-- </ul> -->
                                </div>
                            </td>
