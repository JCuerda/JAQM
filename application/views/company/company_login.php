                        ...
                        <div class="wrapper-page">
                                ...
                                <div class='row'>
                                    <div class='col-md-12'>
                                        <div class='alert alert-success'>
                                            <strong>Successfully Verified Your Accoutn<a class='close' data-dismiss='alert'>&times</a> </strong> 
                                        </div>
                                    </div>
                                </div>
                            <?php endif;?>
                            <div class="m-t-40 account-pages">
                                ...
                                <div class="account-content">
                                    ...
                                    <form class="form-horizontal" action="#" id="company-login-form">
                                        <div class="form-group ">
                                            <div class="col-xs-12">
                                                <input class="form-control" id="company-login-name" type="text" required="" placeholder="Username">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <input class="form-control" id="company-login-pass" type="password" required="" placeholder="Password">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group account-btn text-center m-t-10">
                                            <div class="col-xs-12">
                                                <button class="btn w-md btn-bordered btn-danger waves-effect waves-light" id="company-login-btn" type="submit">Log In</button>
                                            </div>
                                        </div>
