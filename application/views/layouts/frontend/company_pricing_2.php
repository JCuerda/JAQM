                            ...
                            <?php $i = 1; foreach($rates as $rate):?>
                                <article class="pricing-column col-lg-4 col-md-4">
                                    <div class="inner-box card-box">
                                        ...
                                        <div class="text-center">
                                            <button id="process-subscription" data-rate-type="<?php echo $rate->id;?>" data-rate-price="<?php echo $rate->pricing;?>" class="btn btn-danger btn-bordred btn-rounded waves-effect waves-light">Signup Now</button>
                                        </div>
                                    </div>
                                </article>
                            <?php endforeach;?>
