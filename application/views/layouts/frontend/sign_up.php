                        ...
                        <div class="wrapper-page">
                            ...
                            <div class="m-t-40 account-pages">
                                ...
                                <div class="text-center m-b-20">
                                        <div class="m-b-20">
                                            <img src="<?php echo base_url('assets/images/icons/plus.svg"');?>" class="img-circle img-thumbnail thumb-lg" alt="thumbnail">
                                           
                                        </div>
                                        <p class="text-muted m-b-0 font-13">Enter necessary details. </p>
                                    </div>
                                    <form class="form-horizontal" action="">
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <input class="form-control" id="re-password" name="re_pass" type="password" required="" placeholder="Re-Type Password">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group account-btn text-center m-t-10">
                                            <div class="col-xs-12">
                                                <button class="btn w-md btn-danger btn-bordered waves-effect waves-light" type="" id="register-client">Register</button>
                                            </div>
                                        </div>
                            ...
                            <div class="row m-t-50">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted">Already have account?<a href="<?php echo base_url('login');?>" class="text-primary m-l-5"><b>Sign In</b></a></p>
                                </div>
                            </div>
                        </div>
                        <!-- end wrapper -->
